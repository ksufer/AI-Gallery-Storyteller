...
export const TagIcon = ({ className }: { className?: string }) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.593l6.002-2.004c1.114-.371 1.58-1.65 1.05-2.668-.386-.745-1.187-1.15-2.016-1.09l-4.524.323a.75.75 0 00-.676.54l-.45 1.798a.75.75 0 01-1.41-.45l.552-2.208a.75.75 0 00-.73-1.054l-2.268.087a.75.75 0 00-.637 1.077l.784 1.567a.75.75 0 01-1.341.67L9.568 3z" />
  </svg>
);
